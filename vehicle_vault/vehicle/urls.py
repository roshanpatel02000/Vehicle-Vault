...
urlpatterns = [
    ...
    path("vehicles/", views.allVehiclesView, name="all_vehicles"),
    ...
    path("admin-dashboard/vehicles/edit/<int:vehicle_id>/", views.EditVehicleView, name="edit_vehicle"),
    ...
    path("admin-dashboard/comparison-stats/", views.ComparisonStatsView, name="comparison_stats"),
    ...
    path("vehicle/api/save/<int:vehicle_id>/", views.toggle_save_vehicle, name="toggle_save_vehicle"),
    path("saved-vehicles/", views.savedVehiclesView, name="saved_vehicles"),
